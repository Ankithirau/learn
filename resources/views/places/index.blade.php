          ...
          <table id="fileexport-datatable" class="mt-2 table table-bordered key-buttons text-nowrap">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <div class="d-flex">
                    <input type="button" class="btn  btn-warning  editRecord" data-title="State" data-url="{{route('category.edit', $result->id)}}" data-action="{{route('category.update', $result->id)}}" value="Edit">&nbsp;
